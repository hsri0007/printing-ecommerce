...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-[63vh] flex items-center justify-center text-center text-white">
        <Image
          src="/images/services/pamphlets-flyers/pamphlets-flyer-printing.png"
          alt="Printing Services in Hyderabad"
          fill
          priority
          className="object-cover"
        />
        <div className="absolute inset-0 bg-black/90  sm:bg-black/80" />
        <div className="relative z-10 max-w-2xl px-6">
          <h1 className="text-3xl md:text-5xl font-bold text-white text-center">
            All-in-one Printing Services in Hyderabad
          </h1>
          <p className="mt-4 text-lg text-muted-foreground md:text-xl ">
            Based in Uppal & Habsiguda — fast delivery on business cards, flex, banners, hoardings & more.
          </p>
          <div className="mt-6 flex justify-center gap-3">
            <Button variant={"destructive"} size="lg" className="text-lg px-8 py-3" asChild>
              <Link href="#services">
                Browse Services
